        ...
        <div class="card-body">
            <form action="{{ url('/students/store') }}" method="POST">
                ...
                <div class="form-group mt-3">
                  ...
                  <input type="number" name="no" id="no" class="form-control" placeholder="Masukkan No registrasi" required>
                </div>

                <div class="form-group mt-3">
                    <label for="name">Nama Lengkap</label>
                    <input type="text" name="name" id="name" class="form-control" placeholder="Masukkan Nama peserta" required>
                </div>
                ...
                <div class="form-group mt-3">
                    ...
                    <textarea type="text" name="address" id="address" class="form-control" placeholder="Masukkan Alamat peserta" required></textarea>
                </div>
                ...
                <div class="form-group mt-3">
                    ...
                    <input type="text" name="school" id="school" class="form-control" placeholder="Masukkan Asal Sekolah peserta" required>
                </div>
